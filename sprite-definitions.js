...
export const SPRITES = [
  ...
  },
  {
    ...
    sprites: entitySprites(S.offshorePumpE, 69, 56, 8, 4, -1, 6, 13, 11, true),
  },
  {
    path: "graphics/entities/offshore-pump/offshore-pump_West-shadow.png",
    sprites: entitySprites(S.offshorePumpShadowE, 88, 34, 8, 4, -1, 25, -5, 7, true),
  },
  {
    path: "graphics/entities/offshore-pump/offshore-pump_North.png",
    sprites: entitySprites(S.offshorePumpS, 60, 84, 8, 4, 17, 11, 13, 7, true),
  },
  {
    path: "graphics/entities/offshore-pump/offshore-pump_North-shadow.png",
    sprites: entitySprites(S.offshorePumpShadowS, 78, 70, 8, 4, 16, 30, 5, 1, true),
  },
  {
    path: "graphics/entities/offshore-pump/offshore-pump_East.png",
    sprites: entitySprites(S.offshorePumpW, 69, 56, 8, 4, 7, -2, 11, 13, true),
  },
  {
    path: "graphics/entities/offshore-pump/offshore-pump_East-shadow.png",
    sprites: entitySprites(S.offshorePumpShadowW, 88, 34, 8, 4, 2, 22, -1, 3, true),
  },
  {
  ...
  {
    path: "graphics/icons/paste.png",
    sprites: sprites(S.pasteIcon, 64, 64, 1, 1),
  },
  {
